    ...
    return (
        <div>
            ...
            <div className="max-w-7xl mx-auto my-10">
                <h2 className="text-3xl md:text-5xl font-bold text-center"> Our Popular Cars</h2>
                <p className="text-center text-5xl text-[#fd9c01] mb-10">-------------</p>

                <div>{
                    cars.length ?

                        <div className="grid grid-cols-1 md:grid-cols-2 md:gap-5 lg:gap-10 px-5">
                            {
                                cars.map(car => <div key={car._id} className="card card-compact bg-base-100 shadow-xl">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className="flex gap-5">
                                            <button onClick={() => handleDetails(car._id)} className="bg-[#fd9c01] text-white p-2 w-full rounded-lg">Details</button>
